	...
	?>
		...
		<div class="mnm_wrap mnm_button_wrap" style="display:block">
			...
			<div class="add_to_cart_button_wrap mnm_button">
				<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" data-price="<?php echo strip_tags($product->get_price()); ?>" class="single_add_to_cart_button button mnm_add_to_cart_button alt" data-product_id="<?php echo esc_attr( $product->get_id() ); ?>"><span><?php echo esc_html( $product->single_add_to_cart_text() ); ?></span>
															<span class="divider">|</span>
															<span><?php echo get_woocommerce_currency_symbol().$product->get_price(); ?></span></button>
			</div>
